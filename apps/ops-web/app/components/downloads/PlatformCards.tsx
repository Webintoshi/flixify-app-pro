...
const platforms: PlatformItem[] = [
  ...
  },
  {
    id: "android",
    name: "Android",
    subtitle: "Mobil Web Uygulaması · PWA",
    description: "Telefonuna veya tabletine ekle. Mağazaya gerek kalmadan uygulama gibi aç.",
  ...
  },
  {
    ...
    description: "Safari’den ana ekranına ekle. Flixify’ı kendi simgesinden tam ekran aç.",
...
export default function PlatformCards() {
  return (
    <section id="platformlar" className={styles.platformsSection}>
          ...
          {platforms.map((item) => (
            ...
            >
              ...
              <div className={styles.platformActionArea}>
                {item.id === "android" || item.id === "ios" ? (
                  <InstallAction target={item.id} label={item.id === "ios" ? "iPhone / iPad için yükle" : "Android için yükle"} className={styles.actionDetailBtn}/>
                  ...
                  <div className={styles.statusSoonBtn} aria-label={`${item.name}: ${item.statusText}`}>
