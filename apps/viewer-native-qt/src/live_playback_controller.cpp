...
LivePlaybackController::LivePlaybackController(ApiClient *apiClient, QObject *parent)
  : QObject(parent), m_apiClient(apiClient) {
  m_timelineTimer.setInterval(500);
  connect(&m_timelineTimer, &QTimer::timeout, this, &LivePlaybackController::updateTimeline);
...
QString LivePlaybackController::state() const {
  return m_state;
}

QString LivePlaybackController::lastError() const {
  return m_lastError;
}

QString LivePlaybackController::activeChannelId() const {
  return m_activeChannelId;
}

QString LivePlaybackController::activeContentId() const {
  return m_activeTarget.itemId;
}

QString LivePlaybackController::activeContentKind() const {
  return m_activeTarget.kind;
}

QString LivePlaybackController::activeTitle() const {
  return m_activeTarget.title;
}

QString LivePlaybackController::diagnosticsSessionId() const {
  return m_diagnosticsSessionId;
}

QString LivePlaybackController::decoderMode() const {
  return m_decoderMode;
}

QString LivePlaybackController::videoFillMode() const {
  return m_videoFillMode;
}

bool LivePlaybackController::liveFullscreenActive() const {
  return m_liveFullscreenActive;
}

int LivePlaybackController::activeVideoSlot() const {
  return m_activeVideoSlot;
}

void LivePlaybackController::setVideoFillMode(const QString &mode) {
...
void LivePlaybackController::setLiveFullscreenActive(bool active) {
...
bool LivePlaybackController::busy() const {
  return m_busy;
}

bool LivePlaybackController::paused() const {
  return m_paused;
}

double LivePlaybackController::volume() const {
  return m_volume;
}

bool LivePlaybackController::muted() const {
  return m_muted;
}

double LivePlaybackController::positionSeconds() const {
  return m_positionSeconds;
}

double LivePlaybackController::durationSeconds() const {
  return m_durationSeconds;
}

QVariantList LivePlaybackController::audioTracks() const {
  return m_audioTracks;
}

QString LivePlaybackController::selectedAudioTrackId() const {
  return m_selectedAudioTrackId;
}

QVariantMap LivePlaybackController::recommendedNextEpisode() const {
  return m_recommendedNextEpisode;
}

void LivePlaybackController::playChannel(const QString &channelId) {
...
void LivePlaybackController::playVod(const QString &kind, const QString &itemId, const QString &title) {
...
void LivePlaybackController::retryCurrent() {
...
void LivePlaybackController::stop() {
...
void LivePlaybackController::pause() {
  if (!m_player) {
    return;
  }
...
void LivePlaybackController::resume() {
  if (!m_player) {
    return;
  }
...
void LivePlaybackController::togglePause() {
  if (!m_player) {
    return;
  }
...
void LivePlaybackController::setVolume(double value) {
...
void LivePlaybackController::toggleMuted() {
...
void LivePlaybackController::seekTo(double seconds) {
...
void LivePlaybackController::seekBy(double seconds) {
  seekTo(positionSeconds() + seconds);
}

void LivePlaybackController::selectAudioTrack(const QString &trackId) {
  if (!isActiveVod()) {
    return;
  }
...
void LivePlaybackController::playRecommendedNextEpisode() {
...
void LivePlaybackController::setVideoSurfaceHandle(int slotIndex, qulonglong handle) {
...
void LivePlaybackController::setVideoSurfaceGeometry(int slotIndex, int width, int height) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void LivePlaybackController::refreshVideoLayout() {
...
QSize LivePlaybackController::getVideoSize(libvlc_media_player_t *player) const {
  if (!player) {
    return QSize();
  }
...
void LivePlaybackController::updateVideoCrop(int slotIndex) {
...
void LivePlaybackController::setState(const QString &value) {
  if (value == m_state) {
    return;
  }
  m_state = value;
...
void LivePlaybackController::setLastError(const QString &value) {
...
void LivePlaybackController::setActiveChannelId(const QString &value) {
...
void LivePlaybackController::setActiveContent(const PlaybackTarget &target) {
...
void LivePlaybackController::setDiagnosticsSessionId(const QString &value) {
...
void LivePlaybackController::setDecoderMode(const QString &value) {
...
void LivePlaybackController::setBusy(bool value) {
  if (value == m_busy) {
    return;
  }
  m_busy = value;
...
void LivePlaybackController::setPaused(bool value) {
  if (value == m_paused) {
    return;
  }
  m_paused = value;
...
void LivePlaybackController::setVolumeLevel(double value) {
...
void LivePlaybackController::setMuted(bool value) {
  if (value == m_muted) {
    return;
  }
  m_muted = value;
...
void LivePlaybackController::setPositionSeconds(double value) {
...
void LivePlaybackController::setDurationSeconds(double value) {
...
void LivePlaybackController::setAudioTracks(const QVariantList &value) {
...
void LivePlaybackController::setSelectedAudioTrackId(const QString &value) {
...
void LivePlaybackController::setRecommendedNextEpisode(const QVariantMap &value) {
...
void LivePlaybackController::setActiveVideoSlot(int value) {
...
QList<LivePlaybackController::ChannelCandidate> LivePlaybackController::buildCandidateQueue(const QString &channelId) const {
...
void LivePlaybackController::resolveCandidateAt(int index) {
...
void LivePlaybackController::resolveVodSource(const QString &audioTrackId) {
...
void LivePlaybackController::openResolvedSource(const QJsonObject &source, int slotIndex, bool sourceFromCache, bool prefetched) {
...
void LivePlaybackController::advanceToNextCandidate(const QString &reason) {
  setLastError(reason);
...
void LivePlaybackController::failActiveTarget(const QString &reason, const QString &errorCode) {
  m_timelineTimer.stop();
  setLastError(reason);
  setBusy(false);
  setPaused(true);
...
void LivePlaybackController::retryCurrentSourceInSoftwareMode(const QString &reason) {
...
void LivePlaybackController::retryResolvedVodSource(const QString &reason) {
  if (!isActiveVod()) {
...
bool LivePlaybackController::ensurePlayerReady(int slotIndex) {
...
bool LivePlaybackController::ensureAudioOutputReady(libvlc_media_player_t *player) {
  if (!player) {
    return false;
  }
...
void LivePlaybackController::applyAudioState(libvlc_media_player_t *player, bool recoverOutput) {
  if (!player) {
    return;
  }
...
void LivePlaybackController::recreatePlayer(int slotIndex) {
  if (!m_vlc) {
    return;
  }
...
void LivePlaybackController::attachPlayerEvents(int slotIndex) {
  libvlc_media_player_t *player = playerForSlot(slotIndex);
  if (!player) {
    return;
  }
  ...
  libvlc_event_attach(manager, libvlc_MediaPlayerPlaying, &LivePlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerBuffering, &LivePlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerEncounteredError, &LivePlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerStopped, &LivePlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerEndReached, &LivePlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
}

void LivePlaybackController::bindVideoSurface(int slotIndex) {
...
void LivePlaybackController::reportPlaybackEvent(
  const QString &event,
...
void LivePlaybackController::updateTimeline() {
...
void LivePlaybackController::resetPlaybackMetrics() {
  m_timelineTimer.stop();
...
void LivePlaybackController::clearSelectionState() {
  setAudioTracks({});
  setSelectedAudioTrackId(QString());
}

void LivePlaybackController::refreshRecommendedNextEpisode() {
...
bool LivePlaybackController::isActiveLive() const {
  return m_activeTarget.mode == PlaybackMode::Live;
}

bool LivePlaybackController::isActiveVod() const {
  return m_activeTarget.mode == PlaybackMode::Vod;
}

QString LivePlaybackController::currentPlaybackPath(const QString &channelIdOverride) const {
  if (isActiveLive()) {
...
QString LivePlaybackController::normalizedPlatformName() const {
  return m_apiClient ? m_apiClient->normalizedPlatformName() : QStringLiteral("native-qt");
}

QString LivePlaybackController::choosePreferredAudioTrackId(
...
QVariantList LivePlaybackController::mapAudioTracks(const QJsonArray &tracks) {
  QVariantList items;
...
libvlc_media_player_t *LivePlaybackController::currentPlayer() const {
  return playerForSlot(currentPlaybackSlot());
}

libvlc_media_player_t *LivePlaybackController::playerForSlot(int slotIndex) const {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return nullptr;
  }
...
LivePlaybackController::PlayerSlotState &LivePlaybackController::slotState(int slotIndex) {
  return m_playerSlots[slotIndex];
}

const LivePlaybackController::PlayerSlotState &LivePlaybackController::slotState(int slotIndex) const {
  return m_playerSlots[slotIndex];
}

int LivePlaybackController::currentPlaybackSlot() const {
  return m_activeVideoSlot;
}

QString LivePlaybackController::rendererBackendName() const {
...
QString LivePlaybackController::liveResolvePath(const QString &channelId, bool forceRelayRestart) const {
...
void LivePlaybackController::prepareLiveSlot(int slotIndex, const QString &channelId, qint64 requestStartedAt) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void LivePlaybackController::activateLiveSlot(int slotIndex) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void LivePlaybackController::scheduleStopSlot(int slotIndex, int delayMs) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void LivePlaybackController::resetLiveSwitchState() {
  m_liveSwitchInProgress = false;
  m_pendingLiveSlot = -1;
  m_liveSwitchRequestedAt = 0;
}

void LivePlaybackController::clearLiveSourceCache(const QString &channelId) {
  const QString normalizedChannelId = channelId.trimmed();
  if (!normalizedChannelId.isEmpty()) {
...
void LivePlaybackController::storeLiveSourceCache(const QString &channelId, const QJsonObject &source, bool prefetched) {
...
bool LivePlaybackController::tryOpenCachedLiveSource(const QString &channelId, int slotIndex) {
  clearLiveSourceCache();
...
void LivePlaybackController::prefetchLiveChannel(const QString &channelId) {
...
void LivePlaybackController::prefetchLiveCandidates() {
...
void LivePlaybackController::noteLiveIssue(const QString &reason, bool escalateToSafeProfile) {
  if (!isActiveLive()) {
    return;
  }
...
void LivePlaybackController::restartActiveLiveWithSafeProfile(const QString &reason) {
...
void LivePlaybackController::handlePlaying(int slotIndex) {
  setBusy(false);
  setLastError(QString());
  setState(QStringLiteral("playing"));
  setPaused(false);
...
void LivePlaybackController::handleBuffering(int slotIndex, float percent) {
  if (percent < 100.0f) {
...
void LivePlaybackController::handleEncounteredError(int slotIndex) {
  if (!m_retryingSoftwareDecode && decoderMode() == QStringLiteral("hardware")) {
...
void LivePlaybackController::handleStopped(int slotIndex) {
...
void LivePlaybackController::handleEndReached(int slotIndex) {
  if (isActiveLive()) {
...
void LivePlaybackController::handleVlcEvent(const libvlc_event_t *event, void *opaque) {
