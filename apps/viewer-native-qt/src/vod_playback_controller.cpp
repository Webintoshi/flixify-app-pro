...
VodPlaybackController::VodPlaybackController(ApiClient *apiClient, QObject *parent)
  : QObject(parent), m_apiClient(apiClient) {
  m_timelineTimer.setInterval(500);
  connect(&m_timelineTimer, &QTimer::timeout, this, &VodPlaybackController::updateTimeline);
...
QString VodPlaybackController::state() const {
  return m_state;
}

QString VodPlaybackController::lastError() const {
  return m_lastError;
}

QString VodPlaybackController::activeChannelId() const {
  return m_activeChannelId;
}

QString VodPlaybackController::activeContentId() const {
  return m_activeTarget.itemId;
}

QString VodPlaybackController::activeContentKind() const {
  return m_activeTarget.kind;
}

QString VodPlaybackController::activeTitle() const {
  return m_activeTarget.title;
}

QString VodPlaybackController::diagnosticsSessionId() const {
  return m_diagnosticsSessionId;
}

QString VodPlaybackController::decoderMode() const {
  return m_decoderMode;
}

QString VodPlaybackController::videoFillMode() const {
  return m_videoFillMode;
}

bool VodPlaybackController::liveFullscreenActive() const {
  return m_liveFullscreenActive;
}

int VodPlaybackController::activeVideoSlot() const {
  return m_activeVideoSlot;
}

void VodPlaybackController::setVideoFillMode(const QString &mode) {
...
void VodPlaybackController::setLiveFullscreenActive(bool active) {
...
bool VodPlaybackController::busy() const {
  return m_busy;
}

bool VodPlaybackController::paused() const {
  return m_paused;
}

double VodPlaybackController::volume() const {
  return m_volume;
}

bool VodPlaybackController::muted() const {
  return m_muted;
}

double VodPlaybackController::positionSeconds() const {
  return m_positionSeconds;
}

double VodPlaybackController::durationSeconds() const {
  return m_durationSeconds;
}

QVariantList VodPlaybackController::audioTracks() const {
  return m_audioTracks;
}

QString VodPlaybackController::selectedAudioTrackId() const {
...
void VodPlaybackController::playChannel(const QString &channelId) {
...
void VodPlaybackController::playVod(const QString &kind, const QString &itemId, const QString &title) {
...
void VodPlaybackController::retryCurrent() {
...
void VodPlaybackController::stop() {
...
void VodPlaybackController::pause() {
  if (!m_player) {
    return;
  }
...
void VodPlaybackController::togglePause() {
  if (!m_player) {
    return;
  }
...
void VodPlaybackController::setVolume(double value) {
...
void VodPlaybackController::toggleMuted() {
...
void VodPlaybackController::seekTo(double seconds) {
...
void VodPlaybackController::selectAudioTrack(const QString &trackId) {
  if (!isActiveVod()) {
    return;
  }
...
void VodPlaybackController::setVideoSurfaceHandle(int slotIndex, qulonglong handle) {
...
void VodPlaybackController::setVideoSurfaceGeometry(int slotIndex, int width, int height) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void VodPlaybackController::refreshVideoLayout() {
...
QSize VodPlaybackController::getVideoSize(libvlc_media_player_t *player) const {
  if (!player) {
    return QSize();
  }
...
void VodPlaybackController::updateVideoCrop(int slotIndex) {
...
void VodPlaybackController::setState(const QString &value) {
  if (value == m_state) {
    return;
  }
  m_state = value;
...
void VodPlaybackController::setLastError(const QString &value) {
...
void VodPlaybackController::setActiveChannelId(const QString &value) {
...
void VodPlaybackController::setActiveContent(const PlaybackTarget &target) {
...
void VodPlaybackController::setDiagnosticsSessionId(const QString &value) {
...
void VodPlaybackController::setDecoderMode(const QString &value) {
...
void VodPlaybackController::setBusy(bool value) {
  if (value == m_busy) {
    return;
  }
  m_busy = value;
...
void VodPlaybackController::setPaused(bool value) {
  if (value == m_paused) {
    return;
  }
  m_paused = value;
...
void VodPlaybackController::setVolumeLevel(double value) {
...
void VodPlaybackController::setMuted(bool value) {
  if (value == m_muted) {
    return;
  }
  m_muted = value;
...
void VodPlaybackController::setPositionSeconds(double value) {
...
void VodPlaybackController::setDurationSeconds(double value) {
...
void VodPlaybackController::setAudioTracks(const QVariantList &value) {
...
void VodPlaybackController::setSelectedAudioTrackId(const QString &value) {
...
void VodPlaybackController::setActiveVideoSlot(int value) {
...
QList<VodPlaybackController::ChannelCandidate> VodPlaybackController::buildCandidateQueue(const QString &channelId) const {
...
void VodPlaybackController::resolveCandidateAt(int index) {
...
void VodPlaybackController::resolveVodSource(const QString &audioTrackId) {
...
void VodPlaybackController::openResolvedSource(const QJsonObject &source, int slotIndex, bool sourceFromCache, bool prefetched) {
...
void VodPlaybackController::advanceToNextCandidate(const QString &reason) {
  setLastError(reason);
...
void VodPlaybackController::failActiveTarget(const QString &reason, const QString &errorCode) {
  m_timelineTimer.stop();
  setLastError(reason);
  setBusy(false);
  setPaused(true);
...
void VodPlaybackController::retryCurrentSourceInSoftwareMode(const QString &reason) {
...
void VodPlaybackController::retryResolvedVodSource(const QString &reason) {
  if (!isActiveVod()) {
...
bool VodPlaybackController::ensurePlayerReady(int slotIndex) {
...
bool VodPlaybackController::ensureAudioOutputReady(libvlc_media_player_t *player) {
  if (!player) {
    return false;
  }
...
void VodPlaybackController::applyAudioState(libvlc_media_player_t *player, bool recoverOutput) {
  if (!player) {
    return;
  }
...
void VodPlaybackController::recreatePlayer(int slotIndex) {
  if (!m_vlc) {
    return;
  }
...
void VodPlaybackController::attachPlayerEvents(int slotIndex) {
  libvlc_media_player_t *player = playerForSlot(slotIndex);
  if (!player) {
    return;
  }
  ...
  libvlc_event_attach(manager, libvlc_MediaPlayerPlaying, &VodPlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerBuffering, &VodPlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerEncounteredError, &VodPlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerStopped, &VodPlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
  libvlc_event_attach(manager, libvlc_MediaPlayerEndReached, &VodPlaybackController::handleVlcEvent, &m_playerEventContexts[slotIndex]);
}

void VodPlaybackController::bindVideoSurface(int slotIndex) {
...
void VodPlaybackController::reportPlaybackEvent(
  const QString &event,
...
void VodPlaybackController::updateTimeline() {
...
void VodPlaybackController::resetPlaybackMetrics() {
  m_timelineTimer.stop();
...
bool VodPlaybackController::isActiveLive() const {
  return m_activeTarget.mode == PlaybackMode::Live;
}

bool VodPlaybackController::isActiveVod() const {
  return m_activeTarget.mode == PlaybackMode::Vod;
}

QString VodPlaybackController::currentPlaybackPath(const QString &channelIdOverride) const {
  if (isActiveLive()) {
...
QString VodPlaybackController::normalizedPlatformName() const {
  return m_apiClient ? m_apiClient->normalizedPlatformName() : QStringLiteral("native-qt");
}

QString VodPlaybackController::choosePreferredAudioTrackId(
...
QVariantList VodPlaybackController::mapAudioTracks(const QJsonArray &tracks) {
  QVariantList items;
...
libvlc_media_player_t *VodPlaybackController::currentPlayer() const {
  return playerForSlot(currentPlaybackSlot());
}

libvlc_media_player_t *VodPlaybackController::playerForSlot(int slotIndex) const {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return nullptr;
  }
...
VodPlaybackController::PlayerSlotState &VodPlaybackController::slotState(int slotIndex) {
  return m_playerSlots[slotIndex];
}

const VodPlaybackController::PlayerSlotState &VodPlaybackController::slotState(int slotIndex) const {
  return m_playerSlots[slotIndex];
}

int VodPlaybackController::currentPlaybackSlot() const {
  return m_activeVideoSlot;
}

QString VodPlaybackController::rendererBackendName() const {
...
QString VodPlaybackController::liveResolvePath(const QString &channelId, bool forceRelayRestart) const {
...
void VodPlaybackController::prepareLiveSlot(int slotIndex, const QString &channelId, qint64 requestStartedAt) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void VodPlaybackController::activateLiveSlot(int slotIndex) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void VodPlaybackController::scheduleStopSlot(int slotIndex, int delayMs) {
  if (slotIndex < 0 || slotIndex >= static_cast<int>(m_playerSlots.size())) {
    return;
  }
...
void VodPlaybackController::resetLiveSwitchState() {
  m_liveSwitchInProgress = false;
  m_pendingLiveSlot = -1;
  m_liveSwitchRequestedAt = 0;
}

void VodPlaybackController::clearLiveSourceCache(const QString &channelId) {
  const QString normalizedChannelId = channelId.trimmed();
  if (!normalizedChannelId.isEmpty()) {
...
void VodPlaybackController::storeLiveSourceCache(const QString &channelId, const QJsonObject &source, bool prefetched) {
...
bool VodPlaybackController::tryOpenCachedLiveSource(const QString &channelId, int slotIndex) {
  clearLiveSourceCache();
...
void VodPlaybackController::prefetchLiveChannel(const QString &channelId) {
...
void VodPlaybackController::prefetchLiveCandidates() {
...
void VodPlaybackController::noteLiveIssue(const QString &reason, bool escalateToSafeProfile) {
  if (!isActiveLive()) {
    return;
  }
...
void VodPlaybackController::restartActiveLiveWithSafeProfile(const QString &reason) {
...
void VodPlaybackController::handlePlaying(int slotIndex) {
  setBusy(false);
  setLastError(QString());
  setState(QStringLiteral("playing"));
  setPaused(false);
...
void VodPlaybackController::handleBuffering(int slotIndex, float percent) {
  if (percent < 100.0f) {
...
void VodPlaybackController::handleEncounteredError(int slotIndex) {
  if (!m_retryingSoftwareDecode && decoderMode() == QStringLiteral("hardware")) {
...
void VodPlaybackController::handleStopped(int slotIndex) {
...
void VodPlaybackController::handleEndReached(int slotIndex) {
  if (isActiveLive()) {
...
void VodPlaybackController::handleVlcEvent(const libvlc_event_t *event, void *opaque) {
